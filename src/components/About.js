...
function About(){
    ...
    return  <section id="about">
                <div className="about-1">
                    ...
                    <h1>About Us</h1>
                    <hr/>
                    <p>We are a collective of anarcho-capitalist scientists and business people who staunchly disagree with the concept of government and the resulting oppression that inevitably follows. As such, we conduct our business from an undisclosed location in an effort to avoid the authoritarian tendencies that infect even the most "free" countries on this planet.  Because we are free to operate without the restrictive shackles of any foreign government, we are able to bring to you a product that is truly unique, and unable to be obtained from anywhere else on earth. </p>
                </div>
                <div id="about-2">
